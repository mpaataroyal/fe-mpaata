...
import { 
  ...
  TrendingUp, Users, Settings, Bell, Search, X, Loader2,
  Home // <--- 1. IMPORTED HOME ICON
} from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-6 sticky top-0 z-20 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <button className="relative p-2 text-gray-400 hover:text-[#0F2027] transition-colors"><Bell size={20} /></button>
          </div>
        </header>
