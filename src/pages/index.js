      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
              ...
              <div className="relative ml-4">
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-3 w-48 bg-white rounded-[2px] shadow-xl border border-gray-100 py-1 animate-fade-in-up origin-top-right text-[#0F2027]">
                    ...
                    <button
                      onClick={() => navigateToDashboard('bookings')}
                    ...
                    <button
                      onClick={() => navigateToDashboard('payments')}
                      className="w-full text-left px-4 py-2 text-xs font-bold text-gray-600 hover:bg-gray-50 hover:text-[#0F2027] flex items-center gap-2"
                    >
        ...
        >
          {mobileMenuOpen ? (
            <X
              size={24}
              className={scrolled ? 'text-[#0F2027]' : 'text-white'}
            />
          ) : (
            <Menu
              size={24}
    ...
    <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center pt-16">
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 gap-8 pt-4">
          <div>
            <span className="block font-serif text-3xl text-[#D4AF37] mb-1">
              20+
            </span>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 font-light">
            Adorned with gold leaf details and rich satin fabrics, our rooms
            offer a princely respite.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <Link href="/rooms">
            <Button
              type="default"
              className="px-8 py-3 uppercase text-xs tracking-widest"
            >
              View All Suites
            </Button>
          </Link>
        ...
        {items.map((item, idx) => (
          ...
          >
            <div className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#D4AF37] group-hover:text-[#0F2027] transition-all duration-500 shadow-lg">
              <item.icon
                className="group-hover:text-[#0F2027] text-[#D4AF37]"
                size={28}
                strokeWidth={1.5}
              />
            </div>
            <h4 className="font-serif text-lg mb-2 text-[#F3E5AB]">
              {item.title}
            </h4>
    ...
    <section className="relative h-[600px] w-full bg-gray-100 flex items-center justify-center md:justify-start px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full md:ml-24 bg-white/95 backdrop-blur-sm p-10 shadow-2xl rounded-[2px] animate-fade-in-up border-l-4 border-[#D4AF37]">
        ...
        >
          <Button
            type="primary"
            className="w-full uppercase text-xs tracking-widest flex items-center gap-2"
          >
    ...
    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-16">
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif text-xl tracking-widest font-semibold uppercase text-[#0F2027]">
            MPAATA
          </span>
        </div>
        <p className="text-gray-500 text-sm leading-relaxed">
      ...
      <div>
        <h5 className="font-bold text-xs uppercase tracking-widest mb-6 text-[#0F2027]">
          Explore
        </h5>
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm mb-4">
          Subscribe for exclusive royal offers.
        </p>
        <div className="flex border-b border-gray-300 pb-2">
          ...
          />
          <button className="text-xs uppercase font-bold text-[#D4AF37]">
            Join
          </button>
        </div>
      </div>
